...
export async function generatePDF(pdfMake, logoBase64, logoRenardBase64Gris) {
    ...
    const docDefinition = {
        ...
        content: [
            { text: 'Simulateur Epargne', style: 'title' },
    ...
    const fileName = 'SimulateurEpargne-FoxVelocity.pdf'; // Nom du fichier PDF
...
function getIndexationRateInputValue() {
    ...
    function getLastMonthlyContributionValue() {
        ...
        lastMonthlyContributionTexte = nettoyerEtConvertirEspace(lastMonthlyContributionTexte); // Nettoyer les espaces
    ...
    function getSavingsResults() {
        ...
        return {
            table: {
                body: [
                    [{ text: `Montant final :`, alignment: 'left' }, { text: finalAmount, alignment: 'right', bold: true }],
